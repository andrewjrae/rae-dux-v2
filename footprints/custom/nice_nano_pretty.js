...
module.exports =  {
    ...
    body: p => {
      ...
      const gen_traces_row = (row_num) => {
        const traces = `
          (segment (start ${ adjust_point(-7.62, -12.7 + (row_num * 2.54)) }) (end ${ adjust_point(-5.5, -12.7 + (row_num * 2.54)) }) (width 0.4) (layer B.Cu) (net 0))
          (segment (start ${ adjust_point(-7.62, -12.7 + (row_num * 2.54)) }) (end ${ adjust_point(-5.5, -12.7 + (row_num * 2.54)) }) (width 0.4) (layer F.Cu) (net 0))
          (segment (start ${ adjust_point(5.5, -12.7 + (row_num * 2.54)) }) (end ${ adjust_point(7.62, -12.7 + (row_num * 2.54)) }) (width 0.4) (layer B.Cu) (net 0))
          (segment (start ${ adjust_point(7.62, -12.7 + (row_num * 2.54)) }) (end ${ adjust_point(5.5, -12.7 + (row_num * 2.54)) }) (width 0.4) (layer F.Cu) (net 0))
        `
      ...
      const controller = `
        (module nice_nano (layer F.Cu) (tedit 6451A4F1)
          ...
          (pad 2 thru_hole circle (at 7.62 -10.16) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("2").str})
          (pad 3 thru_hole circle (at 7.62 -7.62) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("3").str})
          (pad 22 thru_hole circle (at -7.62 -7.62) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("22").str})
          (pad 23 thru_hole circle (at -7.62 -10.16) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("23").str})
          (pad 24 thru_hole circle (at -7.62 -12.7) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("24").str})

          (pad 21 thru_hole circle (at -7.62 -5.08) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("21").str})
          (pad 4 thru_hole circle (at 7.62 -5.08) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.local_net("4").str})

          (pad 5 thru_hole circle (at 7.62 -2.54) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P21.str : p.local_net("5").str})
          (pad 6 thru_hole circle (at 7.62 0) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P20.str :p.local_net("6").str})
          (pad 7 thru_hole circle (at 7.62 2.54) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P19.str :p.local_net("7").str})
          (pad 8 thru_hole circle (at 7.62 5.08) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P18.str :p.local_net("8").str})
          (pad 9 thru_hole circle (at 7.62 7.62) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P15.str :p.local_net("9").str})
          (pad 10 thru_hole circle (at 7.62 10.16) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P14.str :p.local_net("10").str})
          (pad 11 thru_hole circle (at 7.62 12.7) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P16.str :p.local_net("11").str})
          (pad 12 thru_hole circle (at 7.62 15.24) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P10.str :p.local_net("12").str})
          (pad 13 thru_hole circle (at -7.62 15.24) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P9.str :p.local_net("13").str})
          (pad 14 thru_hole circle (at -7.62 12.7) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P8.str :p.local_net("14").str})
          (pad 15 thru_hole circle (at -7.62 10.16) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P7.str :p.local_net("15").str})
          (pad 16 thru_hole circle (at -7.62 7.62) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P6.str :p.local_net("16").str})
          (pad 17 thru_hole circle (at -7.62 5.08) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P5.str :p.local_net("17").str})
          (pad 18 thru_hole circle (at -7.62 2.54) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P4.str :p.local_net("18").str})
          (pad 19 thru_hole circle (at -7.62 0) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P3.str :p.local_net("19").str})
          (pad 20 thru_hole circle (at -7.62 -2.54) (size 1.7 1.7) (drill 1) (layers *.Cu *.Mask) ${p.minimal_jumpers ? p.P2.str :p.local_net("20").str})
      `;
